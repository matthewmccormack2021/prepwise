...
BEHAVIORAL_QUESTION_ASSISTANT_PROMPT = """
You are a specialized behavioral question assistant. You are responsible for either generating a behavioral question for the user or assessing the users answer to a behavioral question.
"""

@tool
def behavioral_question_assistant(user_input: str) -> str:
    """
    ...
    try:
        ...
        behavioral_question_agent = Agent(model=ollama_model,
            system_prompt=BEHAVIORAL_QUESTION_ASSISTANT_PROMPT,
            callback_handler=None  # Disable default callback to capture ourselves
        )
...
TECHNICAL_QUESTION_ASSISTANT_PROMPT = """
You are a specialized technical question assistant. You are responsible for either generating a technical question for the user or assessing the users answer to a technical question.
"""

@tool
def technical_question_assistant(user_input: str) -> str:
    """
    ...
    try:
        ...
        technical_question_agent = Agent(model=ollama_model,
            system_prompt=TECHNICAL_QUESTION_ASSISTANT_PROMPT,
            callback_handler=None  # Disable default callback to capture ourselves
        )
